...
{               ?>
        <!-- Title -->
        <title><?php echo htmlentities($result->FirstName." ".$result->LastName);?> | Profile</title>
        <?php }} ?>
...
<div class="input-field col s12">
<label for="phone">Parent number</label>
...
<div class="row">
<div class="input-field col m6 s12">
<select  name="gender" autocomplete="off" readonly>
