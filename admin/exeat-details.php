...
// Send
mail('nathanoluwaseyi@gmail.com', 'My Subject', $message);
...
{         
      ?>  
        <!-- Title -->
        <title><?php echo htmlentities($result->FirstName." ".$result->LastName);?> | Exeat Details </title>
        <?php }} ?>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    ...
                    <?php 
$lid=intval($_GET['leaveid']);
$sql = "SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.id,tblemployees.Gender,tblemployees.file_name,tblemployees.Phonenumber,tblemployees.EmailId,tblleaves.LeaveType,tblleaves.ToDate,tblleaves.FromDate,tblleaves.Description,tblleaves.PostingDate,tblleaves.Status,tblleaves.AdminRemark,tblleaves.AdminRemarkDate from tblleaves join tblemployees on tblleaves.empid=tblemployees.id where tblleaves.id=:lid";
$query = $dbh -> prepare($sql);
$query->bindParam(':lid',$lid,PDO::PARAM_STR);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
...
{         
      ?> 
                        <div class="page-title" style="font-size:24px;"><?php echo htmlentities($result->FirstName." ".$result->LastName);?> Exeat Details</div>
                        <?php }} ?>
                    </div>
  <?php
...
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
echo '<img  height="100" width="100" src="../admin/uploads/'.$result->file_name.'" />';
...
<?php 
$lid=intval($_GET['leaveid']);
$sql = "SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.id,tblemployees.Gender,tblemployees.Phonenumber,tblemployees.Hostel,tblemployees.EmailId,tblleaves.LeaveType,tblleaves.ToDate,tblleaves.FromDate,tblleaves.Description,tblleaves.PostingDate,tblleaves.Status,tblleaves.AdminRemark,tblleaves.AdminRemarkDate from tblleaves join tblemployees on tblleaves.empid=tblemployees.id where tblleaves.id=:lid";
$query = $dbh -> prepare($sql);
$query->bindParam(':lid',$lid,PDO::PARAM_STR);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
      ...
      ?>  
                                        ...
                                        <tr>
                                            <td style="font-size:16px;"> <b>Student Name :</b></td>
                                              <td><a href="view-student.php?empid=<?php echo htmlentities($result->id);?>" target="_blank">
                                                <?php echo htmlentities($result->FirstName." ".$result->LastName);?></a></td>
                                              <td style="font-size:16px;"><b>Matric no :</b></td>
                                          ...
                                          <tr>
                                             <td style="font-size:16px;"><b>Student Email :</b></td>
                                            <td><?php echo htmlentities($result->EmailId);?></td>
                                             <td style="font-size:16px;"><b>Parents No :</b></td>
                                            <td><?php echo htmlentities($result->Phonenumber);?></td>
                                            <td style="font-size:16px;"><b>Hostel :</b></td>
                                            <td><?php echo htmlentities($result->Hostel);?></td>
                                            <td>&nbsp;</td>
                                             <td>&nbsp;</td>
                                        </tr>

  <tr>
                                             <td style="font-size:16px;"><b>Exeat Type :</b></td>
                                            <td><?php echo htmlentities($result->LeaveType);?></td>
                                             <td style="font-size:16px;"><b>Exeat Date  :</b></td>
...
<tr>
                                             <td style="font-size:16px;"><b>Description : </b></td>
                                            <td colspan="5"><?php echo htmlentities($result->Description);?></td>
                                          
                                        </tr>

<tr>
<td style="font-size:16px;"><b>Exeat Status :</b></td>
