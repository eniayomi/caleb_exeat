...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Security | View Student</title>
...
{               ?> 
                                        <h3> <?php echo htmlentities($result->FirstName." ".$result->LastName);?> Profile</h3>
                                        <?php }} ?>
                                        <?php
...
<label for="empcode">Matric no</label>
...
<div class="input-field col s12">
<label for="phone">Parents number</label>
...
<div class="input-field col m6 s12">
<input id="birthdate" name="dob"  class="" value="<?php echo htmlentities($result->Dob);?>" readonly >
</div>
...
<div class="row">
<div class="input-field col m6 s12">
<select  name="hostel" autocomplete="off">
<option value="<?php echo htmlentities($result->Hostel);?>"><?php echo htmlentities($result->Hostel);?></option>                                          
</select>
</div>                                                            
