                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">      
                            <span class="chapter-title"><img style="margin-top:-14px; max-width:20%"src="../assets/images/caleb1.png" align="middle"></span>
                        </div>
...
{               ?>  
                                    ...
                                    <li>
                                        <a href="exeat-details.php?leaveid=<?php echo htmlentities($result->lid);?>">
