                          ...
                          <div class="col s12 m6 l8 offset-l2 offset-m3">
                              <div style="margin-right:200px;" class="card white darken-1">
                                  ...
                                  <div class="card-content ">
                                      <span class="card-title" style="font-size:20px; text-align:center;">Password Recovery</span>
                                       ...
                                       <div class="row">
                                           <form class="col s12" name="signin" method="post">
                                               ...
                                               <input style="margin-right:140px;" type="submit" name="submit" value="Submit" class="waves-effect waves-light btn teal">
                                                                                              
                                               </div>
                                           </form>
                                           <h5 style="float: right;"> <a href="/index.php">Login...</a> </h5>
                                      </div>
...
foreach ($results as $result) {
 ...
 <div class="row">
          <span class="card-title" style="font-size:20px; text-align:center; margin-left:150px;">Change your Password </span>                                     
...
<div class="input-field col s12">
<button style="margin-left:160px;" type="submit" name="change" class="waves-effect waves-light btn indigo m-b-xs" onclick=" window.location = /index.php;">Change</button>
